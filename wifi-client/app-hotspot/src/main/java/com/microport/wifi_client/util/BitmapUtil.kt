...
package com.microport.wifi_client.util
 ...
 */
object BitmapUtil {
    fun readBitmap(context: Context, fileName: String): ByteArray {
        ...
        try {
            ...
            e.printStackTrace()
            Log.e("BitmapUtil", "Can't read assets file: $fileName")
        }
    ...
    fun readBitmapFromAssets(context: Context, fileName: String): ByteArray {
        ...
        return getNV21FromBitmap(800, 600, image)
    }
