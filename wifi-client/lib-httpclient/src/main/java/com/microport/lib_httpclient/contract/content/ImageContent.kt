package com.microport.lib_httpclient.contract.content

import com.client.util.ByteUtils
import com.microport.lib_httpclient.exception.DecodeImgPackageException

/**
 * [com.microport.lib_httpclient.contract.Packet]中 content类型 为图像包 所对应的实体
 *
 * @author ouyx
 * @date 2022/11/30 16:10
 *
 */
class ImageContent(private val index: Long, var ts: Long = 0, private val imgBytes: ByteArray) {
