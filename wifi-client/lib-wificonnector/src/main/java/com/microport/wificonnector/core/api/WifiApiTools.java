...
/**
 * Android sdk <=28  WIFI API工具
 *
 * @author ouyx
 * @date 2023年04月04日
 */

public class WifiApiTools {
    ...
    public static WifiConfiguration getConfigViaSSID(Context context, String SSID) {
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            throw new LackOfPermissionException("Invoke WifiManager#getConfiguredNetworks need ACCESS_FINE_LOCATION permission!");
        }
    ...
    public static WifiCipherType getCipherType(String ssid) {
        ...
        if (ActivityCompat.checkSelfPermission(application, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            throw new LackOfPermissionException("Invoke wifiManager#getScanResults lack of Manifest.permission.ACCESS_FINE_LOCATION");
        }
